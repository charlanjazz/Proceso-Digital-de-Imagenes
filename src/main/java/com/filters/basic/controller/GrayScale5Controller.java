 ...
 * @author chars
 */
@ManagedBean(name="gs5")
@javax.faces.bean.ViewScoped
public class GrayScale5Controller implements Serializable {
    ...
    public void aplicar() {
        editor.setImg(grayScale5(editor.getImg2()));
    }
...
//    }
    ...
    public BufferedImage grayScale5(BufferedImage img) {
