 ...
 * @author chars
 */
@ManagedBean(name = "gs6")
@javax.faces.bean.ViewScoped
public class GrayScale6Controller implements Serializable {
    ...
    public void aplicar() {
        editor.setImg(grayScale6(editor.getImg2()));
    }
    ...
    public BufferedImage grayScale6(BufferedImage img) {
        ...
        for (int i = 0; i < w; i++) {
            for (int j = 0; j < h; j++) {
                ...
                int gs = minimo(c.getRed(), c.getGreen(), c.getBlue());
